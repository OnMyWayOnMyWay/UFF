...
import { Home, Star, Users, Trophy, Calendar, Award, Zap, BarChart3, Eye, ArrowRightLeft, TrendingUp, Shield, MoreHorizontal, X, Activity, Sparkles, GitCompare, Play, Scale, Medal } from 'lucide-react';
...
const Navigation = ({ currentPath }) => {
  ...
  const mainNavItems = [
    ...
    { path: '/simulator', icon: Play, label: 'Simulator' },
    { path: '/trade-machine', icon: Scale, label: 'Trade Machine' },
  ...
  return (
    <TooltipProvider>
      ...
      >
        ...
        {showMore && (
          <div 
            className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 nav-dock border border-white/10 rounded-xl p-2 min-w-[360px] animate-slide-up"
